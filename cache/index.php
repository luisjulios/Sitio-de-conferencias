...
<head>
  ...
  <link rel="stylesheet" href="css/colorbox.css">  <link rel="stylesheet" href="css/main.css">
          ...
          <div class="programa-evento">
            <h2>Programa del evento</h2>
                        <nav class="menu-programa">
                                            <a href="#workshop">
                <i class="fa . fa-500px"></i>Workshop</a>
                                            <a href="#workshop">
                <i class="fa . fa-500px"></i>Workshop</a>
                                            <a href="#talleres">
                <i class="fa . fa-code"></i>Talleres</a>
                                            <a href="#conferencias">
                ...
                <i class="fa . fa-university"></i>Seminarios</a>
                            ...
                            <p><i class="fas fa-clock" aria-hidden="true"></i>10:00:00</p>
                            <p><i class="fas fa-calendar-day" aria-hidden="true"></i>2016-12-09</p>
                            ...
                            <p><i class="fas fa-clock" aria-hidden="true"></i>10:00:00</p>
                            <p><i class="fas fa-calendar-day" aria-hidden="true"></i>2016-12-10</p>
                            ...
                            <p><i class="fas fa-clock" aria-hidden="true"></i>17:00:00</p>
                            <p><i class="fas fa-calendar-day" aria-hidden="true"></i>2016-12-09</p>
                            <p><i class="fas fa-user" aria-hidden="true"></i>Rafael Bautista</p>
                          </div>
                                                      <a href="calendario.php" class="button float-right">Ver todos</a>
                      </div>
                            ...
                            <h3>Flexbox</h3>
                            <p><i class="fas fa-clock" aria-hidden="true"></i>12:00:00</p>
                            <p><i class="fas fa-calendar-day" aria-hidden="true"></i>2016-12-09</p>
                            <p><i class="fas fa-user" aria-hidden="true"></i>Shari Herrera</p>
                          </div>
                                                      <a href="calendario.php" class="button float-right">Ver todos</a>
                      </div>
            ...
            <ul class="lista-invitados clearfix">
              ...
              <div style="display: none;">
                <div class="invitado-info" id="invitado1">
                  ...
                  <img src="img/invitados/invitado5.jpg" alt="imagen invitado">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique incidunt ipsa debitis obcaecati veniam, recusandae fugit repellat voluptatibus iste praesentium? Quaerat laboriosam cumque qui veritatis nisi, voluptatem quo mollitia nihil.
              ...
              <div style="display: none;">
                <div class="invitado-info" id="invitado6">
                  ...
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique incidunt ipsa debitis obcaecati veniam, recusandae fugit repellat voluptatibus iste praesentium? Quaerat laboriosam cumque qui veritatis nisi, voluptatem quo mollitia nihil.
                            ...
                            <li>
                <div class="invitado">
                  <a class="invitado-info" href="#invitado10">
                    <img src="img/invitados/IMG_20210228_134935_943.jpg" alt="imagen invitado">
                    <p>Luis Julio</p>
                  </a>
                </div>
              </li>
              <div style="display: none;">
                <div class="invitado-info" id="invitado10">
                  <h2>Luis Julio</h2>
                  <img src="img/invitados/IMG_20210228_134935_943.jpg" alt="imagen invitado">
                  <p>Un pendejo más.</p>
                </div>
...
<!--End mc_embed_signup-->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.colorbox/1.6.4/jquery.colorbox-min.js" integrity="sha512-DAVSi/Ovew9ZRpBgHs6hJ+EMdj1fVKE+csL7mdf9v7tMbzM1i4c/jAvHE8AhcKYazlFl7M8guWuO3lDNzIA48A==" crossorigin="anonymous"></script>  <script src="js/main.js"></script>
