...
if(isset($_POST['nombre_invitado'])) {$nombre = $_POST['nombre_invitado'];}
if(isset($_POST['apellido_invitado'])) {$apellido = $_POST['apellido_invitado'];} 
if(isset($_POST['descripcion'])) {$descripcion = $_POST['descripcion'];} 
if(isset($_POST['id_registro'])) {$id_registro = $_POST['id_registro'];} 


if($_POST['registro'] == 'nuevo') {
  /* $respuesta = array ('post' => $_POST, 'file' => $_FILES); die(json_encode($respuesta));*/
