            ...
            <form role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-evento.php">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="titulo_evento" name="titulo_evento" required placeholder="Título Evento">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="time" class="form-control timepicker" id="hora_evento" name="hora_evento" placeholder="Hora del Evento" required>
                </div>
                <!-- /.form group -->
                <div class="form-group">
